      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h4>ค้นหา ลบข้อมูลสมาชิก</h4>
                  <div class="container">
                        <div class="row">
                          <div class="col-sm-8">
                              <div id="imaginary_container">
                                <form class="form-signin" method="post" action="<?php echo base_url('first/dropmembers'); ?>"  enctype="multipart/form-data">
      ...
      <tbody><?php
       ...
       ?>
        <tr>
          ...
          <td align="center">
            <a class="btn btn-danger btn-sm" href="<?php echo base_url ('first/deletemembers/'.$id)?>"><i class="fa fa-trash-o"></i>&nbsp;ลบ</a>
            <!-- <a class="btn btn-danger btn-sm" href="<?php echo base_url ('first/dropMember/'.$id)?>">ลบ</a> -->
          </td>
        </tr><?php
      }}
        ?>
