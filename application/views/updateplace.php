      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h4>ค้นหา แก้ไขข้อมูลสถานที่</h4>
                  <div class="container">
                        <div class="row">
                          <div class="col-sm-8">
                              <div id="imaginary_container">
                                <form class="form-signin" method="post" action="<?php echo base_url('first/updateplace'); ?>"  enctype="multipart/form-data">
      ...
      <tbody><?php
       ...
       ?>
        <tr>
          ...
          <td align="center">
          <a class="btn btn-success btn-sm" href="<?php echo base_url('first/edit_place/'.$id)?>"><i class="fa fa-pencil-square-o"></i>แก้ไข</a>
          </td>
        </tr><?php
      }}
        ?>
